...
n_H2    = 4411.7646e3;         % mol  (4412 kmol)
n_N2    = 1470.5882e3;       % mol  (1470.5 kmol)
n_total = n_H2 + n_N2;   % total moles
...
P2 = 200;                 % bar final pressure

fprintf('=== SYSTEM SETUP ===\n');
fprintf('n_H2    = %.1f kmol\n', n_H2/1e3);
fprintf('n_N2    = %.1f kmol\n', n_N2/1e3);
fprintf('y_H2    = %.4f,  y_N2 = %.4f\n', y_H2, y_N2);
...
Cp_mix = @(T) y_H2 * Cp_H2(T) + y_N2 * Cp_N2(T);
